...
const stores = [
  ...
  {
    id: 2,
    name: "DJF Shopping Guararapes",
    address: "Av. Barreto de Menezes, N° 800 - Piedade, Jaboatão dos Guararapes - PE, 54410-902",
    city: "Recife - PE",
    phone: "(81) 3094-3194",
    hours: "Seg-Sáb: 10h às 22h | Dom: 12h às 20h",
    image: "/djf-recife.jpeg",
    mapUrl: "https://www.google.com/maps/place/DJF+Acess%C3%B3rios+e+Servi%C3%A7os/data=!4m2!3m1!1s0x0:0xa320e7e02db6e990?sa=X&ved=1t:2428&ictx=111",
  },
  {
    id: 3,
    name: "DJF Norte",
